...
<form id="setupform" method="post" action="<?php $template->the_action_url( 'register' ); ?>">
	...
	<label for="user_name<?php $template->the_instance(); ?>"><?php _e( 'Username:', $theme_my_login->textdomain ); ?></label>
	...
	<span class="hint"><?php _e( '(Must be at least 4 characters, letters and numbers only.)', $theme_my_login->textdomain ); ?></span>

	<label for="user_email<?php $template->the_instance(); ?>"><?php _e( 'Email&nbsp;Address:', $theme_my_login->textdomain ); ?></label>
	...
	<span class="hint"><?php _e( 'We send your registration email to this address. (Double-check your email address before continuing.)', $theme_my_login->textdomain ); ?></span>
	...
	<?php } else { ?>
		...
		<label class="checkbox" for="signupblog"><?php _e( 'Gimme a site!', $theme_my_login->textdomain ); ?></label>
		<br />
		...
		<label class="checkbox" for="signupuser"><?php _e( 'Just a username, please.', $theme_my_login->textdomain ); ?></label>
	<?php } ?>
	</p>

	<p class="submit"><input type="submit" name="submit" class="submit" value="<?php esc_attr_e( 'Next', $theme_my_login->textdomain ); ?>" /></p>
</form>
